		...
		<h3>
			<c:choose>
				<c:when test="${empty menu.id}">
					<fmt:message key="security.menu.add"></fmt:message>
				</c:when>
				<c:otherwise>
		...
		<form action="<c:url value="/security/menu/save"/>" method="post" role="form" class="form-horizontal">
			...
			<fieldset>
				<div class="form-group">
					<label class="col-md-2 control-label" for="name"> <fmt:message key="security.menu.name"></fmt:message>
					</label>
					<div class="col-md-6">
				...
				<div class="form-group">
					<label class="col-md-2 control-label" for="url"> <fmt:message key="security.menu.url"></fmt:message>
					</label>
					<div class="col-md-6">
				...
				<div class="form-group">
					<label class="col-md-2 control-label" for="type"> <fmt:message key="security.menu.type"></fmt:message>
					</label>
					<div class="col-md-6">
				...
				<div class="form-group">
					<label class="col-md-2 control-label" for="parent"> <fmt:message key="security.menu.parent"></fmt:message>
					</label>
					<div class="col-md-6">
