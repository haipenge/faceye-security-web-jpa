...
public class OAuthRestController implements InitializingBean, ApplicationContextAware {
	...
	public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
		if (this.authenticationManager == null) {
			//may be  authenticationManager is :oauth2AuthenticationManager ?
			this.authenticationManager = (AuthenticationManager) applicationContext.getBean("oauth2AuthenticationManager");
		}
	}
}
