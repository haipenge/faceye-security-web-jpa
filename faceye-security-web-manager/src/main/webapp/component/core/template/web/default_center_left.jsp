				  ...
				  <!-- 
					...
					<li><a href="#"><i class="fa fa-list-alt"></i><span>Stocks</span></a>
						<ul class="sub-menu">
						 ...
						 -->
					<c:import url="/component/core/template/web/security_default_center_left.jsp"/>
					<!-- 
					<li><a href="#"><i class="fa fa-home"></i><span><fmt:message key="global.manager"></fmt:message></span></a>
						<ul class="sub-menu">
						
							<li ><a href="<c:url value="/security/user/home"/>"><fmt:message
										key="security.user.manager"></fmt:message></a></li>
							<li><a href="<c:url value="/security/role/home"/>"><fmt:message
										key="security.role.manager"></fmt:message></a></li>
							<li><a href="<c:url value="/security/resource/home"/>"><fmt:message
										key="security.resource.manager"></fmt:message></a></li>
							<li><a href="/security/menu/home"><fmt:message
