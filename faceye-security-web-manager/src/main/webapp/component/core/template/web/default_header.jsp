...
<div class="navbar-header">
	...
	<a class="navbar-brand" href="<c:url value="/"/>"><fmt:message key="global.faceye"></fmt:message></a>
</div>
<div class="navbar-collapse collapse">
	<ul class="nav navbar-nav">
		<li class="active"><a href="<c:url value="/default/index"/>"><fmt:message key="global.home"></fmt:message></a></li>
		<!--  
	...
	<ul class="nav navbar-nav navbar-right user-nav">
		<li class="dropdown profile_menu"><a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img alt="Avatar"
				src="<c:url value="/js/lib/clean-zone/images/avatar2.jpg"/>" /> <span> <c:if test="${not empty pageContext.request.userPrincipal}">
